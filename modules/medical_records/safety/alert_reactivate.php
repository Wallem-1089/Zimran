...
$result = $clinicalSafetyService->reactivateAlert($id, (string)($_POST['reason'] ?? ''), (int)$currentUser['id'], (int)($_POST['version'] ?? 0), $visitId);
$_SESSION[$result['success'] ? 'success_message' : 'validation_errors'] = $result['success'] ? 'Clinical alert reactivated.' : $result['errors'];
