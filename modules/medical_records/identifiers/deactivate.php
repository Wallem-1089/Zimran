...
$result=$identifierService->deactivateIdentifier($id,(string)($_POST['reason']??''),(int)$currentUser['id']); $_SESSION[$result['success']?'success_message':'validation_errors']=$result['success']?'Identifier deactivated.':$result['errors']; header('Location: view.php?id='.$id); exit;
