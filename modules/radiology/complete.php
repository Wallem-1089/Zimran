...
if (!$permissionService->canCompleteRadiologyRequest($visit, $currentUser)) {
    http_response_code(403);
    exit('You cannot complete this radiology request.');
}

$result = $radiologyService->completeRequest($requestId, $currentUser);
radiologyFlash($result, 'Radiology request completed.');
