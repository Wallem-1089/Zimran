...
if (!$permissionService->canProcessRadiologyRequest($visit, $currentUser)) {
    ...
    exit('You cannot cancel this radiology request.');
}

$result = $radiologyService->cancelRequest($requestId, $currentUser);
radiologyFlash($result, 'Radiology request cancelled.');
