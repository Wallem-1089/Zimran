...
if (!$permissionService->canProcessPhysiotherapyRequest($visit, $currentUser)) {
    ...
    exit('You cannot process this physiotherapy request.');
}

$result = $physiotherapyService->startRequest($requestId, $currentUser);
physiotherapyFlash($result, 'Physiotherapy request started.');
