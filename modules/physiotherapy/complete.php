...
if (!$permissionService->canCompletePhysiotherapyRequest($visit, $currentUser)) {
    http_response_code(403);
    exit('You cannot complete this physiotherapy request.');
}

$result = $physiotherapyService->completeRequest($requestId, $currentUser);
physiotherapyFlash($result, 'Physiotherapy request completed.');
