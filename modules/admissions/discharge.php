...
<main class="content">
    ...
    <form method="post" action="discharge_save.php" class="card form-card" <?= $enableWritingMode ? 'data-hms-handwriting-form="1"' : '' ?>>
        <?= csrfField() ?>
        ...
        <?php hmsRenderHandwritingToolbar($enableWritingMode, 'Admission Discharge Entry Mode'); ?>
        <?php hmsRenderHandwritingTextarea('discharge_notes', 'Discharge Notes', '', 6, true, $enableWritingMode); ?>
