...
if (!$permissionService->canCompleteEcgRequest($visit, $currentUser)) {
    http_response_code(403);
    exit('You cannot complete this ECG request.');
}

$result = $ecgService->completeRequest($requestId, $currentUser);
ecgFlash($result, 'ECG request completed.');
