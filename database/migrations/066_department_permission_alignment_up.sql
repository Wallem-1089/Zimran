-- Align ECG and POP department permissions with the current patient-context rule.
-- Clinical departments may view patient-specific context, but mutate only their own department workflow.
